<div class="chat-container">
    <div class="flex flex-row justify-center">
        <div class="basis-1/4">
            ...
            <div>
              <livewire:chat.chat-list :selectedConversation="$selectedConversation" :query="$searchQuery">
            </div>
        </div>
